    ...
    <EditZone>
      <section id="contact" className="relative overflow-hidden py-24 sm:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
          <p className="reveal font-mono text-xs uppercase tracking-[0.3em] text-lilac">contact</p>
          <h2 className="reveal reveal-up mt-4 font-display text-3xl font-bold tracking-tight text-ink sm:text-[2.6rem]">
            一起做点<span className="aurora-text">温柔又炫酷</span>的东西
          </h2>
          <p className="reveal reveal-up mx-auto mt-5 max-w-lg text-[15px] leading-relaxed text-ink-soft" data-reveal-delay="120">
          ...
          <div className="reveal reveal-up mt-10 flex flex-wrap items-center justify-center gap-3" data-reveal-delay="200">
            {settings.social_links.length === 0 && (
              <span className="inline-flex items-center gap-2 rounded-full bg-white/60 px-5 py-2.5 text-sm text-muted-foreground backdrop-blur">
